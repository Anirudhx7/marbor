...
export const mockGPUNodes: GPUNode[] = [
  {
    ...
    uptime: '14d 6h 23m',
    loadedModels: [
      { name: 'llama3.1:70b', vramUsed: 40.2, status: 'warm' },
      { name: 'mixtral:8x7b', vramUsed: 26.5, status: 'warm' },
    ],
  ...
  },
  {
    ...
    uptime: '12d 14h 45m',
    loadedModels: [
      { name: 'llama3.1:8b', vramUsed: 16.2, status: 'warm' },
      { name: 'mistral:7b', vramUsed: 14.8, status: 'warm' },
      { name: 'qwen2.5:14b', vramUsed: 21.3, status: 'warm' },
    ],
  ...
  },
  {
    ...
    uptime: '8d 2h 15m',
    loadedModels: [
      { name: 'llama3.2:3b', vramUsed: 4.2, status: 'warm' },
      { name: 'gemma2:9b', vramUsed: 14.1, status: 'warm' },
    ],
  ...
  },
  {
    ...
    uptime: '3d 8h 52m',
    loadedModels: [
      { name: 'phi3:medium', vramUsed: 4.2, status: 'warm' },
    ],
