...
- **VALIDATED (Ollama + NVIDIA):** [README.md's TTFT benchmark section](https://github.com/Anirudhx7/marbor/blob/main/README.md#ttft-performance-the-business-case) - a deployed marbor v0.13.1 routing to a real single consumer-GPU Ollama node, measured with `bench/ttft.go`.
